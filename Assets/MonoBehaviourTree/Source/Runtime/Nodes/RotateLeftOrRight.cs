...
namespace MBT
{
  ...
  [MBTNode(name = "PCG/RotateLeftOrRight")]
  public class RotateLeftOrRight : Leaf
  {
      ...
      public override NodeResult Execute()
      {
          ...
          Vector2Int[] directionsAfterUp = {Vector2Int.right, Vector2Int.left};
          Vector2Int[] directionsAfterDown = {Vector2Int.right, Vector2Int.left};
          Vector2Int[] directionsAfterLeft = {Vector2Int.up, Vector2Int.down};
          Vector2Int[] directionsAfterRight = {Vector2Int.up, Vector2Int.down};
